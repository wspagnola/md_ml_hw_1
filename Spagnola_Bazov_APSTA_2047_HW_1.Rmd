...
(nrow(taxi_data))
taxi_data<- taxi_data %>% select(-store_and_fwd_flag, -vendor_id, -pickup_longitude, -pickup_longitude, -rate_code, -dropoff_latitude, -dropoff_longitude, -payment_type) #Remove unneeded columns 
