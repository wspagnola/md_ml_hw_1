...
##Merge Trips and Fares into One Dataframe called Taxi Data
```{r}

taxi_data <- inner_join(x = trips_hw_1, y = fares_hw_1) 
...
#NOTE! : Add Earnings once we Merge with fares. Resolved.-Emanuel  
